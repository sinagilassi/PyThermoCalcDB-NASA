...
## Version check (`examples/exp-0.py`)
- Imports the package and prints `pythermocalcdb_nasa.__version__` to confirm installation.
...
## Species property evaluation (`examples/exp-2.py`)
...
## Reaction thermodynamics (`examples/exp-3.py`)
...
## Build NASA pickles (`examples/build-thermodb.py`)
